  ...
  <body>
    ...
    <div id="menuNavbarMobile" style="margin-left: 100%;">
      <div class="row" style="margin-top:50px">
        ...
        <div id="elementsProjectsMobile" class="col-sm-12 col-12 navElementsMobile">Projects</div>
        <div id="elementsContactsMobile" class="col-sm-12 col-12 navElementsMobile">Contacts</div>
      </div>
      <div id="showContentMobile" style="width:100%; display:flex; justify-content:center; padding-top:30px"
        class="navElementsMobil2e"> <img class="mainflags" id="englandFlag"
              src="https://img.icons8.com/fluency/48/000000/england-circular.png" />
        <div id="contentMobile" style="display: none; flex-direction: row;">
          ...
          <div class=""> <a href="../IT/"> <img class="mainflags" id="italianFlag" 
          ...
          <div class="text-right" style="margin:0; padding:0;display: flex;flex-direction: row;align-content: end;">
            ...
            <div id="projectsNav" class="underline" style="display:flex; align-items:right; justify-content: right;">
              <div id="elementsProjects" style="display:flex; align-items:right; justify-content: right;">
                ...
                <div class="elNav1">c</div>
                <div class="elNav1">t</div>
                <div class="elNav1">s</div>
              </div>
            </div>
            <div style="width:10px"></div>
            <div id="contactsNav" class="text-right underline"
              ...
              <div id="elementsContacts" style="display:flex; align-items:right; justify-content: right;">
                ...
                <div class="elNav2">c</div>
                <div class="elNav2">t</div>
                <div class="elNav2">s</div>
              </div>
            </div>
            <div id="dropdown" class="text-right underline">
              <span id="showContent"></span>
              <img class="flags" id="englandFlag" style="display:"
                      src="https://img.icons8.com/fluency/48/000000/england-circular.png" />
      ...
      <div id="calcPage2" style="">
        <div class="row">
          <div class="col-md-6 col-sm-12 col-12" style=" padding-bottom: 3vmin;">
            ...
            Hi, my name is Alessio and I'm 24 years old. I've an Italian high school diploma. I also study new programming languages 
            and I implement projects in team or alone. 
          ...
          <div class="col-md-6 col-sm-12 col-12 aboutCol">
            <div class="row" style="color:white">
              ...
              <div id="aboutText" class="col-md-6 col-sm-12 col-12">
                ...
                <div id="text1" class="name2" style="display:none">Hi,&nbsp;</div>
                  <div id="text2" class="name2" style="display:none">my&nbsp;</div>
                  <div id="text3" class="name2" style="display:none">name&nbsp;</div>
                  <div id="text4" class="name2" style="display:none">is&nbsp;</div>
                  <div id="text5" class="name2" style="display:none">Alessio&nbsp;</div>
                  <div id="text6" class="name2" style="display:none">and&nbsp;</div>
                  <div id="text7" class="name2" style="display:none">I'm&nbsp;</div>
                  <div id="text8" class="name2" style="display:none">24&nbsp;</div>
                  <div id="text9" class="name2" style="display:none">years&nbsp;</div>
                  <div id="text10" class="name2" style="display:none">old.&nbsp;</div>
                  <div id="text11" class="name2" style="display:none">I've&nbsp;</div>
                  <div id="text12" class="name2" style="display:none">an&nbsp;</div>
                  <div id="text13" class="name2" style="display:none">italian&nbsp;</div>
                  <div id="text14" class="name2" style="display:none">high&nbsp;</div>
                  <div id="text15" class="name2" style="display:none">school&nbsp;</div>
                  <div id="text16" class="name2" style="display:none">diploma.&nbsp;</div>
                  <div id="text17" class="name2" style="display:none">I&nbsp;</div>
                  <div id="text18" class="name2" style="display:none">also&nbsp;</div>
                  <div id="text19" class="name2" style="display:none">study&nbsp;</div>
                  <div id="text20" class="name2" style="display:none">new&nbsp;</div>
                  <div id="text21" class="name2" style="display:none">programming&nbsp;</div>
                  <div id="text22" class="name2" style="display:none">languages&nbsp;</div>
                  <div id="text23" class="name2" style="display:none">and&nbsp;</div>
                  <div id="text24" class="name2" style="display:none">I&nbsp;</div>
                  <div id="text25" class="name2" style="display:none">implements&nbsp;</div>
                  <div id="text26" class="name2" style="display:none">projects&nbsp;</div>
                  <div id="text27" class="name2" style="display:none">in&nbsp;</div>
                  <div id="text28" class="name2" style="display:none">team&nbsp;</div>
                  <div id="text29" class="name2" style="display:none">or&nbsp;</div>
                  <div id="text30" class="name2" style="display:none">alone.&nbsp;</div>
                  <div id="text31" class="name2" style="display:none">I&nbsp;</div>
                  <div id="text32" class="name2" style="display:none">have&nbsp;</div>
                  <div id="text33" class="name2" style="display:none">the&nbsp;</div>
                  <div id="text34" class="name2" style="display:none">knowledge.&nbsp;</div>
                  <div id="text35" class="name2" style="display:none">Some&nbsp;</div>
                  <div id="text36" class="name2" style="display:none">of&nbsp;</div>
                  <div id="text37" class="name2" style="display:none">my&nbsp;</div>
                  <div id="text38" class="name2" style="display:none">Skills&nbsp;</div>
                  <div id="text39" class="name2" style="display:none">are:&nbsp;</div>
    ...
    <div id="page3">
      ...
      <div class="row rowCarousel" style="">
        ...
        It's a project realized using Laravel Framework and these languages: HTML5, PHP, Javascript, CSS, MySQL.
The website was made to allow users to keep under control their eating style through daily foods insertion. <br>
Following there are works done:

          <br>
          <b>-</b> Sign-in and Login;
          <br>
          <b>-</b> Calculation of BMI according to personal information inserted during registration;
          <br>
          <b>-</b> Daily tracking of calories and macronutrients using a graphic;
          <br>
          <b>-</b> Research and insertion of foods inside of database;
          <br>
          <b>-</b> Ability to customize a plate grouping multiple foods;
          <br>
          <b>-</b> Data summary page where user can modify his data (personal information, goals to achieve).
        </div>
      ...
      <div class="row rowScopri">
        <div class="col-md-6 col-sm-12 col-12 text-center textScopri" style="margin:0; padding:0;">
          <a href="http://gestionemiosito.altervista.org/Nuovo/public/" style="color:#0049ff">Discover more
        </div></a>
      </div>
      ...
      <div class="row" style="height:100%">
        <div class="col-md-12 col-12 col-sm-12" style="height:100%">
          <div class="row contactSubtitleParent" style="height:10vh;align-content:end;">
            <div id="contactSubtitle" class="contactSubtitle col-md-12 text-center">Do you want to work with me?</div>
          </div>
          <div class="row" style="align-content:start; padding-bottom:2vmin">
            <div id="contactTitle" class="contactTitle col-md-12 text-center">Contact me</div>
          </div>
              ...
              <div class="col-md-6 col-sm-8 col-10">
                <div class="row justify-content-md-center justify-content-sm-center justify-content-center"
                  ...
                  <div class="col-md-12 col-sm-12 col-12" style="height:10%">
                    <input type="text" class="inputContact" id="name" name="name" placeholder="Name" required>
                  </div>
                  ...
                  <div class="col-md-12 col-sm-12 col-12" style="height:40%">
                    <textarea class="inputContact" placeholder="message" id="message" name="message" required></textarea>
                  </div>
                  <div class=" col-md-12 col-sm-12 col-12" style="height:20%; padding-top:15px; padding-bottom:15px">
                    <input type="submit" id="buttonContact" class="inputContact" name="submit" value="send">
                  </div>
                </div>
              </div>
            </div>
