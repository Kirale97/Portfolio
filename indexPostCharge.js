...
function LingueMobile() {
  if (CheckFlag) {
    document.getElementById("contentMobile").style.display = "flex";
    CheckFlag = false;
  } else {
    document.getElementById("contentMobile").style.display = "none";
    CheckFlag = true;
  }
}
  ...
  postData('https://portfolioalessio.com/sender.php', {
    ...
    .then(data => {
      if(data==0 || data=="0"){
        ...
        document.getElementById("colMessage").innerHTML="Die Nachricht wurde erfolgreich versendet";
        ...
        document.getElementById("colMessage").style.animation="";
        document.getElementById("colMessage").innerHTML="Fehler. Versuche es später";
        document.getElementById("colMessage").style.animation="anMessage 5s linear";
      }
    });
}