  ...
  <body>
    ...
    <div id="menuNavbarMobile" style="margin-left: 100%;">
      <div class="row" style="margin-top:50px">
        ...
        <div id="elementsProjectsMobile" class="col-sm-12 col-12 navElementsMobile">Projekte</div>
        <div id="elementsContactsMobile" class="col-sm-12 col-12 navElementsMobile">Kontakte</div>
      </div>
      <div id="showContentMobile" style="width:100%; display:flex; justify-content:center; padding-top:30px"
        class="navElementsMobil2e"> <img class="mainflags" id="germanFlag"
                src="https://img.icons8.com/fluency/48/000000/germany-circular.png" />
          ...
          <div class="text-right" style="margin:0; padding:0;display: flex;flex-direction: row;align-content: end;">
            ...
            <div id="projectsNav" class="underline" style="display:flex; align-items:right; justify-content: right;">
              <div id="elementsProjects" style="display:flex; align-items:right; justify-content: right;">
                ...
                <div class="elNav1">j</div>
                <div class="elNav1">e</div>
                <div class="elNav1">k</div>
      ...
      <div id="calcPage2" style="">
        <div class="row">
          <div class="col-md-6 col-sm-12 col-12" style=" padding-bottom: 3vmin;">
            ...
            Hallo, ich heiße Alessio und ich bin 24 Jahre alt.
Ich wurde im Fachgebiet Informatik diplomiert.
Ich widme mich den populären Sprachen der heutigen Zeit und 
realisiere im Alleingang Projekte. Hier einige Fähigkeiten, die ich besitze:
          </div>
        </div>
      </div>
            ...
            <div class="row" style="color:white">
              ...
              <div id="aboutText" class="col-md-6 col-sm-12 col-12">
                <div class="row justify-content-md-center justify-content-sm-center justify-content-center">
                  <div id="text1" class="name2" style="display:none">Hallo&nbsp;</div>
                  <div id="text2" class="name2" style="display:none">,&nbsp;</div>
                  <div id="text3" class="name2" style="display:none">ich&nbsp;</div>
                  <div id="text4" class="name2" style="display:none">heiße&nbsp;</div>
                  <div id="text5" class="name2" style="display:none">Alessio&nbsp;</div>
                  <div id="text6" class="name2" style="display:none">und&nbsp;</div>
                  <div id="text7" class="name2" style="display:none">ich&nbsp;</div>
                  <div id="text8" class="name2" style="display:none">bin&nbsp;</div>
                  <div id="text9" class="name2" style="display:none">24&nbsp;</div>
                  <div id="text10" class="name2" style="display:none">Jahre&nbsp;</div>
                  <div id="text11" class="name2" style="display:none">alt.&nbsp;</div>
                  <div id="text12" class="name2" style="display:none">Ich&nbsp;</div>
                  <div id="text13" class="name2" style="display:none">wurde&nbsp;</div>
                  <div id="text14" class="name2" style="display:none">im&nbsp;</div>
                  <div id="text15" class="name2" style="display:none">Fachgebiet&nbsp;</div>
                  <div id="text16" class="name2" style="display:none">Informatik&nbsp;</div>
                  <div id="text17" class="name2" style="display:none">diplomiert.&nbsp;</div>
                  <div id="text18" class="name2" style="display:none">Ich&nbsp;</div>
                  <div id="text19" class="name2" style="display:none">widme&nbsp;</div>
                  <div id="text20" class="name2" style="display:none">mich&nbsp;</div>
                  <div id="text21" class="name2" style="display:none">den&nbsp;</div>
                  <div id="text22" class="name2" style="display:none">populären&nbsp;</div>
                  <div id="text23" class="name2" style="display:none">Sprachen&nbsp;</div>
                  <div id="text24" class="name2" style="display:none">der&nbsp;</div>
                  <div id="text25" class="name2" style="display:none">heutigen&nbsp;</div>
                  <div id="text26" class="name2" style="display:none">Zeit&nbsp;</div>
                  <div id="text27" class="name2" style="display:none">und&nbsp;</div>
                  <div id="text28" class="name2" style="display:none">realisiere&nbsp;</div>
                  <div id="text29" class="name2" style="display:none">im&nbsp;</div>
                  <div id="text30" class="name2" style="display:none">Alleingang&nbsp;</div>
                  <div id="text31" class="name2" style="display:none">Projekte.&nbsp;</div>
                  <div id="text32" class="name2" style="display:none">Hier&nbsp;</div>
                  <div id="text33" class="name2" style="display:none">einige&nbsp;</div>
                  <div id="text34" class="name2" style="display:none">Fähigkeiten,&nbsp;</div>
                  <div id="text35" class="name2" style="display:none">die&nbsp;</div>
                  <div id="text36" class="name2" style="display:none">ich&nbsp;</div>
                  <div id="text37" class="name2" style="display:none">besitze:&nbsp;</div>
    ...
    <div id="page3">
      ...
      <div class="row rowCarousel" style="">
        ...
        Ein Projekt, realisiert durch folgende Framework Laravel und folgenden Sprachen:
HTML5, PHP, JavaScript, CSS und MySQL.
Die Website wurde gecodet, um Nutzern einen Überblick über ihre Kalorienzunahme zu
verschaffen, indem man die tägliche Nahrungszufuhr dokumentiert.
Derzeit kann man mit dieser Website folgendes machen:
          <br>
          <b>-</b> Eine Registrierung und einen Login;
          <br>
          <b>-</b> Die Berechnung des BMIs basierend auf die eingetragenen Informationen, welche 
   bei der Registrierung angegeben wurden;
          <br>
          <b>-</b> Die tägliche Verfolgung der Kalorienzufuhr und Makronährstoffe mittels einer Grafik;
          <br>
          <b>-</b> Das Eintragen der Lebensmittel in die interne Datenbank;
          <br>
          <b>-</b> Die Möglichkeit, eine Mahlzeit zu einem zusammenzufassen (Teller zusammenstellen);
          <br>
          <b>-</b> Die eigenen Profilinformationen zu aktualisieren.
        </div>
      ...
      <div class="row rowScopri">
        <div class="col-md-6 col-sm-12 col-12 text-center textScopri" style="margin:0; padding:0;">
          <a href="http://gestionemiosito.altervista.org/Nuovo/public/" style="color:#0049ff">Erfahre mehr
        </div></a>
      </div>
      ...
      <div class="row" style="height:100%">
        <div class="col-md-12 col-12 col-sm-12" style="height:100%">
          <div class="row contactSubtitleParent" style="height:10vh;align-content:end;">
            <div id="contactSubtitle" class="contactSubtitle col-md-12 text-center">Willst du mit mir arbeiten? </div>
          </div>
          <div class="row" style="align-content:start; padding-bottom:2vmin">
            <div id="contactTitle" class="contactTitle col-md-12 text-center">Kontaktiere mich</div>
          </div>
            ...
            <div class="row justify-content-md-center justify-content-sm-center justify-content-center">
              <div class="col-md-6 col-sm-8 col-10">
                <div class="row justify-content-md-center justify-content-sm-center justify-content-center"
                  ...
                  <div class="labelContacts col-md-12 col-sm-12 col-12">
                    <span class="">Nachricht:</span><br>
                  </div>
                  <div class="col-md-12 col-sm-12 col-12" style="height:40%">
                    <textarea class="inputContact" placeholder="Schreibe eine Nachricht" id="message" name="message" required></textarea>
                  </div>
                  <div class=" col-md-12 col-sm-12 col-12" style="height:20%; padding-top:15px; padding-bottom:15px">
                    <input type="submit" id="buttonContact" class="inputContact" name="submit" value="Abschicken">
                  </div>
                </div>
              </div>
            </div>
